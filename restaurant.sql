...
COPY restaurants (id, name, type, ranking_average, vegan, price_range, area, address, phone, website) FROM stdin;
\.
...
COPY reviews (id, review_description, ranking, reviewer_id, review_date, restaurant_id) FROM stdin;
\.
...
SELECT pg_catalog.setval('reviews_id_seq', 45, true);
...
COPY users (id, user_name, user_password) FROM stdin;
\.
